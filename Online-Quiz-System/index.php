...
<!-- contains admin modal,sign-in,sign-up form & sign-up form validation -->

<title>Online-Intelligent-Quiz-System</title>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:#a8df65">STUDENT SIGN IN</span></h4>
      </div>
...
<div class="col-md-7">
  <img src="image/img-01.png" alt="IMAGE" class="center"></div>
<div class="col-md-4 panel">
      ...
      <div class="form-group">
        ...
        <div class="col-md-12">
          <input  type="submit" class="sub" value="SIGN UP" class="btn btn-warning"/>
        </div>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:#a8df65; font-family:'typo' ">ADMIN LOGIN</span></h4>
      </div>
